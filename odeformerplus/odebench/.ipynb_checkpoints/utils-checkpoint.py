...
def plot_odebench(idx, noise_sig=0.02, drop_rate=0.2, rescale=True, print_desc=False, figsize=None, ncols=3, **kwargs):
    trajs_list, sequence_list = solve_odebench(idx, noise_sig, drop_rate, rescale, print_desc)
